## [1.32.0](https://github.com/atanuroy22/morphe-patches/compare/v1.31.1...v1.32.0) (2026-06-23)

### 🐛 Bug Fixes

* **YouTube - Bypass link redirects:** Resolve patch not working on community posts and video descriptions ([#1755](https://github.com/atanuroy22/morphe-patches/issues/1755)) ([c5c6376](https://github.com/atanuroy22/morphe-patches/commit/c5c6376546efdc90cbf89f7f5554880432161b22))
* **YouTube - Change form factor:** Prevent app crash when using tablet mode in `onResume` state ([#1803](https://github.com/atanuroy22/morphe-patches/issues/1803)) ([4b0de25](https://github.com/atanuroy22/morphe-patches/commit/4b0de256e74f6eeb279ba164146fb9a01f2f8176))
* **YouTube - Copy video link button:** Wrong localization resource name ([dbddc1a](https://github.com/atanuroy22/morphe-patches/commit/dbddc1a55ea37e90bb7bfae221dd86a4a042b5fb))
* **YouTube - Disable player popup panels:** Deprecated the old way to disable popup panels ([709b4fb](https://github.com/atanuroy22/morphe-patches/commit/709b4fb5f5a98713903befbbc3a54e4a11e9a668))
* **YouTube - Disable player popup panels:** Patch doesn't work in some circumstances ([6d6018c](https://github.com/atanuroy22/morphe-patches/commit/6d6018cf4a4ee6f79a283001aebe5b9d21767741))
* **YouTube - Hide layout components:** Resolve "Hide horizontal shelves" hiding other components ([#930](https://github.com/atanuroy22/morphe-patches/issues/930)) ([3c53157](https://github.com/atanuroy22/morphe-patches/commit/3c5315774896dc78ab5ad4d7b44380f9a21d3312))
* **YouTube - Link sanitize:** Live links sanitize doesn't work ([ad91b37](https://github.com/atanuroy22/morphe-patches/commit/ad91b3759c42befbf4c32804cad5de5a48f14255))
* **YouTube - Navigation bar:** Prevent navigation bar animation when swiping to dismiss miniplayer ([#1800](https://github.com/atanuroy22/morphe-patches/issues/1800)) ([dcc4c0c](https://github.com/atanuroy22/morphe-patches/commit/dcc4c0c28ac600ca057c8720f5e71f8c712011ac))
* **YouTube - Override YouTube Music buttons:** Target app opens when clicking on 'YouTube Music' button inside explore menu ([#1707](https://github.com/atanuroy22/morphe-patches/issues/1707)) ([1f08df2](https://github.com/atanuroy22/morphe-patches/commit/1f08df24848bce582919e21b4b3e3f7bb6ebe5ab))
* **YouTube - Reload video:** App exits after pressing back button ([#1740](https://github.com/atanuroy22/morphe-patches/issues/1740)) ([743bc76](https://github.com/atanuroy22/morphe-patches/commit/743bc76743c529aa8f6da4ecffd9643088c7fd97))
* **YouTube - Remove viewer discretion dialog:** In-app video downloader does not work for Premium users ([#1756](https://github.com/atanuroy22/morphe-patches/issues/1756)) ([3353302](https://github.com/atanuroy22/morphe-patches/commit/3353302753352388dbeef9454bb7902cdeb9eae0))
* **YouTube - Spoof video streams:** Always allow details fetching ([6bc0eee](https://github.com/atanuroy22/morphe-patches/commit/6bc0eeefe02fa89a5d0669698ceb2fffc5bc51c7))
* **YouTube Music - Track crossfade:** Dismissing the queue does not stop playback, fix songs incorrectly skipped ([#1773](https://github.com/atanuroy22/morphe-patches/issues/1773)) ([206b84e](https://github.com/atanuroy22/morphe-patches/commit/206b84eb6b20f873edee53253fd8460a993a30ab))

### ✨ New Features

* **YouTube - Hide layout components:** Add "Hide video comments by keywords" setting ([#1759](https://github.com/atanuroy22/morphe-patches/issues/1759)) ([d076c2b](https://github.com/atanuroy22/morphe-patches/commit/d076c2b3b7c561952fa2ae94be5d4de3119439af))
* **YouTube - Hide video action buttons:** Add "Restore old video action bar", "Hide Connect button", and "Hide More button" settings ([#1780](https://github.com/atanuroy22/morphe-patches/issues/1780)) ([0481899](https://github.com/atanuroy22/morphe-patches/commit/0481899aef98c45aa3cc88c9e3ff5cc8387fb4c5))
* **YouTube - Navigation bar:** Restore "Hide Cast button" setting in toolbar ([c27e63e](https://github.com/atanuroy22/morphe-patches/commit/c27e63ecb464b1e85e6ff97f13e21cc641a99fe7))
* **YouTube - Open videos fullscreen:** Add landscape mode option ([#1770](https://github.com/atanuroy22/morphe-patches/issues/1770)) ([c2e78f1](https://github.com/atanuroy22/morphe-patches/commit/c2e78f14c4539479213623cb62587f02051ff421))
* **YouTube Music:** Add experimental support for `9.23.52` ([#1747](https://github.com/atanuroy22/morphe-patches/issues/1747)) ([31f0c4a](https://github.com/atanuroy22/morphe-patches/commit/31f0c4a503226ce7e6ffa58eb8f32af2f1f92f8c))
* **YouTube Music:** Add experimental support for `9.24.51` ([d30738a](https://github.com/atanuroy22/morphe-patches/commit/d30738a771222c8181623371a2f3b27b442dc478))
* **YouTube:** Add `Disable fullscreen gesture` patch ([#1724](https://github.com/atanuroy22/morphe-patches/issues/1724)) ([00ec593](https://github.com/atanuroy22/morphe-patches/commit/00ec59355d57c66f1189b779ab6806c7dcdd5fd3))
* **YouTube:** Hide toolbar chat button ([32ee079](https://github.com/atanuroy22/morphe-patches/commit/32ee07910d9d80a8f3eac3b6f0dd0968a6c6c81d))

### 🚀 Updated App Support

* **Reddit:** Add experimental support for `2026.24.0` ([eb47573](https://github.com/atanuroy22/morphe-patches/commit/eb4757326ef90cf6cf9865b12bd451603cb8a111))
* **Reddit:** Add experimental support for `2026.25.0` ([d1a8fcc](https://github.com/atanuroy22/morphe-patches/commit/d1a8fccf5dfbec51eec36d1f49cdf2a9fe50847d))
* **YouTube Music:** Add support for `9.15.51` ([4ef13c7](https://github.com/atanuroy22/morphe-patches/commit/4ef13c7a0475c1b9f3aeac3613711df81806b461))
* **YouTube:** Add experimental support for `21.25.523` ([773b386](https://github.com/atanuroy22/morphe-patches/commit/773b386ba8d8bb0c831dee82880b0fcdbbd58b75))
